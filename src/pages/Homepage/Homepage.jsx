    ...
    <div className="container mx-auto p-4">
      ...
      <Slider {...settings}>
        {images.map((image, index) => (
          <div key={index} className="p-4">
             ...
             */}
             ...
             <div className=" md:my-10 bg-green-50 flex flex-col items-center justify-center">
                <div className="title-news ">
                    <h1 className='text-blue-950 text-center my-10  font-bold font-san text-3xl'>News / Events</h1>
                </div>
            ...
            {isMobile ? (
                <Slider {...setting}>
                    {news.map((item, index) => (
                        <div key={index} className="p-4">
                            <div className="new-container border rounded-lg shadow-md p-4">
                                <div className="img-cont">
                                    <img src={item.img} alt={item.alt} className="w-full h-48 object-cover rounded-lg"/>
                                </div>
                                <div className="text-con font-sans mt-5">
                                    <h1 className="text-lg font-bold my-3">{item.heading}</h1>
                                    <p className="tracking-wide">{item.paragraph}</p>
                                </div>
                                <div className="like-cont flex my-4 text-xs gap-4">
                                    <p className="flex gap-2" onClick={() => handleIconClick(index, 0)}>
                                        <span role="img" aria-label="like">👍</span> {item.socialicons[0].count}
                                    </p>
                                    <p className="flex gap-2" onClick={() => handleIconClick(index, 1)}>
                                        <span role="img" aria-label="message">💬</span> {item.socialicons[1].count}
                                    </p>
                                    <p className="flex gap-2" onClick={() => handleIconClick(index, 2)}>
                                        <span role="img" aria-label="dislike">👎</span> {item.socialicons[2].count}
                                    </p>
                                </div>
                                <div className="btn-cont">
                                    <button className="bg-blue-950 px-7 py-2 rounded-lg text-white font-bold font-playfair">
                                        Read more
                                    </button>
                                </div>
                            </div>
                        ...
                        <div key={index} className="p-4">
                            <div className="new-container w-80 ">
                                ...
                                <div className="text-con  mt-5 font-roboto">
                                    <h1 className="text-lg font-bold my-3">{item.heading}</h1>
                                    <p className="w-64 tracking-wide">{item.paragraph}</p>
                                </div>
                                <div className="like-cont flex my-4 text-xs gap-4">
                                    <p className="flex gap-2" onClick={() => handleIconClick(index, 0)}>
                                        <span role="img" aria-label="like"><svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M8.59379 10.7872H10.1348V8.47564H12.4464V6.93461H10.1348V4.62307H8.59379V6.93461H6.28226V8.47564H8.59379V10.7872ZM1.65918 16.9513V1.54102H17.0694V13.8692H4.74123L1.65918 16.9513ZM3.20021 13.2336L4.10556 12.3282H15.5284V3.08205H3.20021V13.2336ZM3.20021 13.2336V3.08205V12.3282V13.2336Z" fill="#2E7D32"/>
                                    ...
                                    <p className="flex gap-2" onClick={() => handleIconClick(index, 2)}>
                                        <span role="img" aria-label="dislike"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
